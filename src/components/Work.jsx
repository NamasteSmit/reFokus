...
const Work = () => {
   ...
   let images = [
    ...
    {url:"https://assets-global.website-files.com/6334198f239547d0f9cd84b3/634ef0acbc45cb2f4fc5c6b2_Yahoo.png" , top: "47%" , left: "45%" ,isActive: false},
    ...
    {url:" https://assets-global.website-files.com/6334198f239547d0f9cd84b3/634ef0af108a465002975acd_Showcase%20Websites%20(1).png" , top: "65%" , left: "60%" ,isActive: false},
   ]
               ...
               <div className=' absolute top-0 w-full h-full'>
                {
                    images.map((image,index)=>                       image.isActive && (
                            <img src={image.url} alt="" className='absolute w-60 rounded-lg -translate-x-[50%] -translate-y-[50%]' style={{top:image.top , left:image.left}} key={index} />
                        )
                    )
                }
               </div>
